...
<body>
    <form class="form-login">
        <Center><img src="Davi-plata.png" title="" width="350" height="100" class="logo"></Center>
        <input class="controls" type="text" name="Cedula" value="" placeholder="Cedula">
        <input class="controls" type="password" name="contraseña" value="" placeholder="Contraseña">
        <center><a input class="buttons" href="bolsillo?accion=DashboardD" target="_blank">INGRESAR</a></center>
